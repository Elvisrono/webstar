                ...
                <div className="lg:container mx-auto">
                    ...
                    <div className="grid grid-cols-4">
                        ...
                        <div className="newsletter">
                            ...
                            <form  className="max-w-[424px] w-full flex items-center gap-2">
                                <input type="email" placeholder="Your Email.." className="max-w-[285px] text-[#9a9caa] w-full h-[46px] border-[#e1e3e5] border-[1px] rounded-lg pl-2" />
            ...
            <div className="footer_bottom w-full h-[75px] flex items-center justify-center ">
                <div className="lg:container mx-auto">
                    <div className="flex items-center justify-between">
                        <div>
                           <p className="text-base text-[#9a9caa] font-normal font-inter">@ 2025 WebDev- Designed & Develop <span className="text-[#272343]">Code4life</span></p> 
                        </div>
