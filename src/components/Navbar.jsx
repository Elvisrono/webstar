...
const Navbar = () => {
    return (
        <div >
            ...
            {/* nabvar top  */}
            <div className="navbar_top flex items-center justify-center bg-[#272343]  w-full h-10">
                ...
                <div className="lg:container flex justify-between items-center">
                    ...
                    <div className="navbar_top_right flex items-center gap-6">
                        <select defaultValue="Server location" className="bg-transparent h-[30px] w-[70px] text-sm font-inter font-normal capitalize text-white ">
                ...
                <div className="lg:container grid grid-cols-3 items-center">
                    ...
                    <div className="navbar_middle_right flex items-center gap-4">
                        ...
                        <button className="btn capitalize">
                            <ShoppingCart /> cart 
                            <div className="badge badge-sm bg-[#b60c0ccc]">2</div>
                        </button>
                        <button className="btn capitalize">
                            <Heart />
                        </button>
                        ...
                        <div className="dropdown">
                            ...
                            <ul tabIndex={0} className="dropdown-content menu bg-base-300 rounded-box z-1 w-20 p-2 shadow-sm">
            ...
            {/* navbar bottom  */}
            <div className="navbar_bottom flex  justify-center w-full h-[75px] bg-white border-b-[1px] border-[#e1e3e5]">
